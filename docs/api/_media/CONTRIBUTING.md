...
2. Clone your fork: `git clone https://github.com/baxelson12/hyperliquidx.git`
3. Navigate to the project directory: `cd hyperliquidx`
...
Thank you for contributing to hyperliquidx!
